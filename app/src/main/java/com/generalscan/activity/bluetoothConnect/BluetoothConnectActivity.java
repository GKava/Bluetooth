...
public class BluetoothConnectActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		requestWindowFeature(Window.FEATURE_NO_TITLE); // полноэкранное окно
	...
	private void setListener() {
		// Конфигурация Bluetooth для системы отображения и Open Bluetooth
		...
		//Выберите спаренный bluetooth-сканер
		...
		myBtnSendContent.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				// 获取输入的命令 Получить введенную команду
		...
		myBtnSendList.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				// 显示所有发送内容，详见SendList类  Показывать весь отправленный контент, см. Класс SendList.
	...
	public class ReadBroadcast extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			//Принять передачу данных мощности n
			...
			// Получение широковещательной передачи данных
			...
			//Получать трансляции, которые отправляют данные
